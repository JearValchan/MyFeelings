package armando.valencia.myfeelings.utilities

import android.content.Context
import android.graphics.*
import android.graphics.drawable.Drawable
import androidx.core.content.ContextCompat
import armando.valencia.myfeelings.R
...
class CustomBarDrawable: Drawable {
    ...
    override fun draw(canvas: Canvas) {
        ...
        var ancho = (canvas.width - 10).toFloat()
        var alto = (canvas.height - 10).toFloat()
        ...
        if (this.emocion != null){
            val porcentaje = this.emocion!!.porcentaje*(canvas.width - 10)/100
